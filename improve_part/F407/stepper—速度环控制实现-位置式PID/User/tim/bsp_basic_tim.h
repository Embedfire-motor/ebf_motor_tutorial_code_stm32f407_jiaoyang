...
#define BASIC_PERIOD_COUNT    (50)//20ms

//定时器时钟源TIMxCLK = 2 * PCLK1  
//				PCLK1 = HCLK / 4 
//				=> TIMxCLK=HCLK/2=SystemCoreClock/2=84MHz
#define BASIC_PRESCALER_COUNT   (84000)
...
#define GET_BASIC_TIM_PERIOD()      ((__HAL_TIM_GET_AUTORELOAD(&TIM_PIDHandle)+1)/50.0)     // 获取定时器的周期，单位ms
